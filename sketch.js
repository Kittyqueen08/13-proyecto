...
function preload(){
  ...
  red_balloonImage = loadImage("red_balloon0.png");
  //carga la imagen de redBalloon, este es el codigo correcto ya que si esta la imagen red_balloon0.png
}
...
// }
 ...
 function redBalloon() {
   ...
   red.lifetime = 150;
   red.scale = 0.1;
   //crea la funcion redBalloon en posiciones al azar
 }
